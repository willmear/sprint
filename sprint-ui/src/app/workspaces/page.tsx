    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-2 font-display text-4xl font-bold text-ink">Your workspaces</h1>
          <p className="mt-2 max-w-2xl text-sm text-stone-600">
            Each workspace belongs to your authenticated account and isolates Jira connections, synced sprint data, generated reviews, and job history.
          </p>
        </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[0.8fr_1.2fr]">
        <Card>
          ...
          <p className="mt-2 text-sm text-stone-600">Start a new workspace under your authenticated account.</p>
          <div className="mt-6">
            <CreateWorkspaceForm />
          </div>
        </Card>
        ...
        <Card>
          ...
          <p className="mt-2 text-sm text-stone-600">Pick a workspace to authorize Jira access, sync sprints, or inspect latest review.</p>
