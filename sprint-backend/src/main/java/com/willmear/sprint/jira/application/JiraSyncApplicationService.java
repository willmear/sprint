...
public class JiraSyncApplicationService implements JiraSyncService {
    ...
    private final ListAvailableJiraSprintsUseCase listAvailableJiraSprintsUseCase;
    ...
    public JiraSyncApplicationService(
            ...
            ListAvailableJiraSprintsUseCase listAvailableJiraSprintsUseCase,
        ...
        this.listAvailableJiraSprintsUseCase = listAvailableJiraSprintsUseCase;
    ...
    @Override
    public List<AvailableJiraSprint> listAvailableSprints(UUID workspaceId, UUID connectionId) {
        return listAvailableJiraSprintsUseCase.list(workspaceId, connectionId);
    }
